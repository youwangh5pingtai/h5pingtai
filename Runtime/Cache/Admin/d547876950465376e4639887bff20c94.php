        ...
        <div id="tab1" class="tab-pane in tab1 tab-look">
    		<table  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="l">游戏接口：</td>
                    <td class="r">
                        <input type="text" class="txt" name="game_api" value="" placeholder="游戏接口">
                    </td>
                  </tr>
                  <tr>
                    <td class="l">分成比例：</td>
                  ...
                  <tr>
                    ...
                    <td class="r">
                        <label class="inp_radio">
                            ...
                            <input type="checkbox" class="inp_radio" value="0" name="recommend_status[]">不推荐
                            <input type="checkbox" class="inp_radio" value="1" name="recommend_status[]" checked="checked">推荐
                            <input type="checkbox" class="inp_radio" value="2" name="recommend_status[]" >热门
                            <input type="checkbox" class="inp_radio" value="3" name="recommend_status[]" >最新
                        </label>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="l">游戏QQ群</td>
                    <td class='r'><input type="text" class='txt' name='qq_group' value=""></td>
                  </tr>
                  <tr>
                    <td class="l">语言：</td>
                    <td class="r">
